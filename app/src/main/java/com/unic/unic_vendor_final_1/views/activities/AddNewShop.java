...
import com.unic.unic_vendor_final_1.databinding.ActivityAddNewShopBinding;
import com.unic.unic_vendor_final_1.databinding.AddNewShopBinding;
...
public class AddNewShop extends AppCompatActivity implements View.OnClickListener{

    private AddNewShopViewModel addNewShopViewModel;
    private ActivityAddNewShopBinding addNewShopBinding;
    private Shop shop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNewShopBinding = ActivityAddNewShopBinding.inflate(getLayoutInflater());
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==addNewShopBinding.addShopStep2.getId()){
            ...
            Intent locationIntent = new Intent(AddNewShop.this, LocationSelector.class);
